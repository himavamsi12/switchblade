    ...
    <section style={{ background: "#ffffff", overflow: "hidden" }}>
      ...
      >
        ...
        <div style={{ paddingTop: "clamp(8px, 1vw, 16px)", maxWidth: "clamp(180px, 21vw, 300px)" }}>
          ...
          <p style={{ fontFamily: "var(--font-archivo)", fontSize: "clamp(10px, 0.82vw, 13px)", fontWeight: 700, letterSpacing: "0.09em", textTransform: "uppercase", lineHeight: 1.85, color: "#0D0D0D", opacity: 0.75 }}>
